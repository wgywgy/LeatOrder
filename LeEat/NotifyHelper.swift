...
class NotifyHelper: NSObject {
    ...
    func alarmDate() -> NSDate {
        ...
        let newDate = cal.dateBySettingHour(14, minute: 30, second: 0, ofDate: date, options: NSCalendarOptions())!
//        let newDate = cal.dateBySettingHour(17, minute: 50, second: 0, ofDate: date, options: NSCalendarOptions())!
